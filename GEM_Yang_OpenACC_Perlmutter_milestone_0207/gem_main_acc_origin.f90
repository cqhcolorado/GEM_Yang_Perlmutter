...
!        w2(ns,m)=2.*amp*(revers(MyId*cnt+m,13)-0.5) !(ran2(iseed) - 0.5 )
        w2(m,ns)=2.*amp*sin(4*pi2/ly*y2(m,ns))*exp(-(z2(m,ns)-lz/2)**2/(lz/8)**2)*exp(-(x2(m,ns)-0.5*lx)**2/(lx/8)**2) &
                +2.*amp*sin(3*pi2/ly*y2(m,ns))*exp(-(z2(m,ns)-lz/2)**2/(lz/8)**2)*exp(-(x2(m,ns)-0.5*lx)**2/(lx/8)**2) &
                +2.*amp*sin(5*pi2/ly*y2(m,ns))*exp(-(z2(m,ns)-lz/2)**2/(lz/8)**2)*exp(-(x2(m,ns)-0.5*lx)**2/(lx/8)**2) &
                +2.*amp*sin(6*pi2/ly*y2(m,ns))*exp(-(z2(m,ns)-lz/2)**2/(lz/8)**2)*exp(-(x2(m,ns)-0.5*lx)**2/(lx/8)**2)
        if(ns==2)w2(m,ns) = 0.
