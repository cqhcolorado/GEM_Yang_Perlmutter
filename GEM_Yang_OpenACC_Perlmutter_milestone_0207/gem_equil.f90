MODULE gem_equil
  IMPLICIT NONE
  integer :: itube,ibase,iperi,iperidf,ibunit,icandy=0,isprime=0,ildu=0,eldu=0,igmrkr=0,igmrkre=0,ig0=0,ig0e=0
...
contains
  subroutine new_equil()
      ...
      integer :: i,j,k,m,j1,j2,ileft(0:nr)
...
10       format(1x,i5,12(1x,e16.9))
         do i = 0,nr
            r = rin+i*dr
            write(11,10)i,r/a,sf(i),f(i),t0e(i),t0i(i),xn0e(i),xn0i(i),dbdth(i,ntheta/4),dbdth(i,ntheta/2),dbdth(i,ntheta),psip(i)
         end do
      end if
